    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieInteractions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovieInteractions_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieInteractions_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieInteractions_MovieId",
                table: "MovieInteractions",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieInteractions_UserId",
                table: "MovieInteractions",
                column: "UserId");
